...
Program ini dibuat untuk [memenuhi tugas mobile dengan dan program ini juga di buat agar kita bisa memahami penggunaan tipe data seperti string, int, double].
